...
Unspecified — означает отсутствие приоритета. Приоритет выбирается самостоятельно в зависимости от окружающей среды (текущей загруженности системы). Напоследок давайте рассмотрим пример использования приоритетов:
*/
